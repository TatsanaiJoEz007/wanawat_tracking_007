...
<head>
    ...
    <title>จัดการใบส่งสินค้า IV - Wanawat Tracking System</title>
...
<body>
    ...
    <section class="home-section">
        ...
        <div class="home-content">
            ...
            <span class="text">จัดการใบส่งสินค้า IV</span>
        </div>
            ...
            <div class="content-container animate__fadeInUp">
                ...
                <div class="product-table-container">
                    <table>
                        ...
                        <tbody>
                            <?php
                            // Your SQL Query for IV delivery (NOT LIKE '%ic%')
                            ...
                            if (empty($merged_rows)) {
                                ...
                                echo "<strong>ไม่มีสินค้ารอเลือกบิล IV</strong><br>";
                                echo "<small>ยังไม่มีข้อมูลสินค้าที่พร้อมสำหรับการสร้างบิล IV</small>";
                                echo "</td>";
                                echo "</tr>";
                            } else {
