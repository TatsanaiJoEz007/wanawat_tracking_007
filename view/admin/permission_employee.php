                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="#" id="register" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="password" class="form-control" id="emp_pass" name="emp_pass" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="emp_img" class="form-label">รูปภาพ</label>
                                                <input type="file" class="form-control" id="emp_img" name="emp_img" optional>
                                            </div>
                                            <div class="mb-3">
                                                <label for="status" class="form-label">สถานะ</label>
                                                <select class="form-select" id="emp_status" name="emp_status" required>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#register').submit(function(event) {
                ...
                $.ajax({
                    url: 'function/action_employee/action_addemp.php',
                    type: 'POST',
        ...
        function delUser(id) {
            let option = {
                url: 'function/action_employee/action_delemp.php',
                type: 'post',
                dataType: 'json',
                data: {
                    id: id,
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#resetPasswordForm').submit(function(e) {
                ...
                $.ajax({
                    url: 'function/action_employee/action_empreset.php',
                    type: 'post',
