...
<body>
    ...
    <div class="container text-center">
        <div class="tracking-input-group">
            ...
            <p>&nbsp; &nbsp;</p>
            <input type="text" class="form-control tracking-input" id="trackingIdInput" name="trackingId" placeholder="<?php echo htmlspecialchars($lang_track); ?> (Ex. WDL#############)" required>
                    ...
                    if (xhr.readyState == 4 && xhr.status == 200) {
                        ...
                        if (response.status === 'match') {
                            Swal.fire({
                                ...
                                window.location.href = `../view/tracking_page.php?trackingId=${encodeURIComponent(trackingId)}`; // Redirect with trackingId as parameter
                            });
                        } else {
                            Swal.fire({
                                icon: 'error',
