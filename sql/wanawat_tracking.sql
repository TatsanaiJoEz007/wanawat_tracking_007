...
ALTER TABLE `amphures`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_povinces_id` (`province_id`);
...
ALTER TABLE `districts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_amphure_id` (`amphure_id`);
...
ALTER TABLE `provinces`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_geography_id` (`geography_id`);
...
ALTER TABLE `tb_user`
  ...
  ADD KEY `fk_amphures_id` (`amphure_id`);
